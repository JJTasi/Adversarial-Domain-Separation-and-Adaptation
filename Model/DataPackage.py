...
def datapackage(source, target, max_feature, tfidf_setting, validate_rate=0.05):
    np.random.seed(123)
    
    #please change the file path to your own path
    if tfidf_setting == 'union':
        source_file = '/home/jay/DSN/Dataset/Amazon_Reviews/Set_union_mf'+str(max_feature)+'/'+source+'_mf'+str(max_feature)+'.npy'                
        ...
        target_file = '/home/jay/DSN/Dataset/Amazon_Reviews/Set_union_mf'+str(max_feature)+'/'+target+'_mf'+str(max_feature)+'.npy'
        ...
        file = '/home/jay/DSN/Dataset/Amazon_Reviews/Set_seperate_mf'+str(max_feature)+'/'+source+'2'+target+'_mf'+str(max_feature)+'.npy'                
        data = np.load(file)
        #source
        train_fts, train_label = data[0]                
